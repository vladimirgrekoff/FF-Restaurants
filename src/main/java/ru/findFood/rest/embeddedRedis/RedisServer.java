...
import ru.findFood.rest.embeddedRedis.AbstractRedisInstance;
import ru.findFood.rest.embeddedRedis.RedisExecProvider;
import ru.findFood.rest.embeddedRedis.RedisServerBuilder;
...
public class RedisServer extends AbstractRedisInstance {
  private static final String REDIS_READY_PATTERN = ".*# Сервер инициализирован.*";
