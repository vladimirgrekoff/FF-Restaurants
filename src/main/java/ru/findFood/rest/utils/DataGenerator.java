...
public class DataGenerator {
    ...
    public void generateData() {
        ...
        RestaurantInfo restaurantInfo1 = new RestaurantInfo(restaurant1, faker.company().industry(), faker.backToTheFuture().character(), faker.address().streetAddress(), faker.phoneNumber().phoneNumber(), faker.internet().emailAddress(), faker.job().seniority());
        ...
        RestaurantInfo restaurantInfo2 = new RestaurantInfo(restaurant2, faker.company().industry(), faker.backToTheFuture().character(), faker.address().streetAddress(), faker.phoneNumber().phoneNumber(), faker.internet().emailAddress(), faker.job().seniority());
        ...
        RestaurantInfo restaurantInfo3 = new RestaurantInfo(restaurant3, faker.company().industry(), faker.backToTheFuture().character(), faker.address().streetAddress(), faker.phoneNumber().phoneNumber(), faker.internet().emailAddress(), faker.job().seniority());
        ...
        RestaurantInfo restaurantInfo4 = new RestaurantInfo(restaurant4, faker.company().industry(), faker.backToTheFuture().character(), faker.address().streetAddress(), faker.phoneNumber().phoneNumber(), faker.internet().emailAddress(), faker.job().seniority());
